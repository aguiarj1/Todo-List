...
/**
 * This is  represents a lit of Projects. 
 * @author Joel Aguiar
 */
...
public class ProjectList {
	...
	//This method creates a file or add the content of a file to ProjectList
	...
	//This method read the data from a file and converts them to ProjectItems
	...
	private void getRecords() throws IOException{
		...
		while((st = br.readLine()) != null){
			...
			//make a new object
			Project item = new Project(Integer.parseInt(data[0]),
					data[1], 
		...
		biggestID++; 
		Project.setIdCount(biggestID); 
	}

	private void addToLinkedListInOrder(Project item){
	...
	public  void add(String description, String date){
		...
		Project item = new Project(description, d); 
